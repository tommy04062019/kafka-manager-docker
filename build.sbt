...
/* End RPM Settings */
minhbts-MacBook-Pro:kafka-manager-docker minhbt$ ls
Dockerfile	LICENSE		README.md	build.sbt	robust_build.sh
minhbts-MacBook-Pro:kafka-manager-docker minhbt$ clear
minhbts-MacBook-Pro:kafka-manager-docker minhbt$ cat build.sbt
/**
 * Copyright 2015 Yahoo Inc. Licensed under the Apache License, Version 2.0
 * See accompanying LICENSE file.
 */
